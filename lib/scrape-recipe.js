...
async function extractWithClaude(html, sourceUrl) {
  ...
  // out of tokens partway through (this is exactly what happened with a
  // long Nigella recipe — lots of ingredients + long instructions pushed
  // past the old 2000-token limit). Check explicitly rather than letting
  // JSON.parse fail with an opaque "Unterminated string" error.
